...
Файл: `backend/app.js`
Для написания backend сайта, а та же для хранения и подтягивания карточек в формате .json
...
Для проверки работоспособности сайта, Post, Get
...
Для расширения возмодностей сайта, для простого создания карточек товаров и упрощения взаимодействия фаловой системы
...
Для быстрого получения информации и администрирования и маштабирования, документирования
